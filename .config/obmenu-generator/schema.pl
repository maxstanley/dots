...
our $SCHEMA = [
    ...
    {item => ['alacritty -e tmux attach',            'TMUX Terminal',     'utilities-terminal']},
    {item => ['alacritty',            'Terminal',     'utilities-terminal']},
    {item => ['firefox http://', 'Web Browser',  'web-browser']},
    ...
    {sep => undef},
    {beg => ['ScreenShot', 'applications-engineering']},

      # Take ScreenShot Now
      {item => ['scrot',               'Take ScreenShot Now', 'scrot']},

      # Take ScreenShot in 1 Second
      {item => ['scrot --delay 1',               'Take ScreenShot in 1 Second', 'scrot']},

      # Take ScreenShot in 3 Seconds
      {item => ['scrot --delay 3',               'Take ScreenShot in 3 Seconds', 'scrot']},

      # Take ScreenShot in 5 Seconds
      {item => ['scrot --delay 5',               'Take ScreenShot in 5 Seconds', 'scrot']},

      # Select ScreenShot
      {item => ['scrot --select',               'Select ScreenShot Area', 'scrot']},
